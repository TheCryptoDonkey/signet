...
| **Time-grant signing approvals to an app** (NIP-46 with policy) | [`charter`](https://github.com/forgesworn/charter) | Clause evaluator + pairing storage |
...
**[`charter`](https://github.com/forgesworn/charter)** — Parent-led, libre game account management. Time, spend, content, and comms grants on your own keys, no platform required. Built on Signet.
